...
class Scenario_1(Page):
    ...
    def vars_for_template(self):
        return {'player_index': self.player.id_in_group,
                'comply': Constants.compliance_amount,
                'non-comply': Constants.stag_hare_amount,
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        return {
             'total_payoff': self.player.payoff + Constants.fixed_pay + Constants.earnings}
